...
!(function (t) {
  ...
  (b.prototype.getMargin = function (t) {
    ...
    (b.prototype.toStepping = function (t) {
      return (
        (t = h(this.xVal, this.xPct, t)), this.direction && (t = 100 - t), t
      );
    }),
  ...
  function A(t, e) {
    if (
      ((t.format = e), "function" == typeof e.to && "function" == typeof e.from)
    )
      return !0;
            ...
            n.forEach(function (r, i) {
              ...
              if (
                ...
                for (s = w; s <= x; s = (s + a).toFixed(7) / 1) {
                  ...
                  (h = n.indexOf(s) > -1 ? 1 : "steps" === e ? 2 : 0),
                    !i && u && (h = 0),
                    (s === x && c) || (o[d.toFixed(5)] = [s, h]),
                    (l = d);
                }
            }),
            (b.direction = i),
      ...
      var i = function (e) {
          return (
            ...
            (i.classList
              ...
              : !new RegExp("\\b" + o + "\\b").test(i.className)) &&
              ((e = (function (t, e) {
                t.preventDefault();
                var n,
                  r,
                ...
                return (
                  ...
                  (e = e || s()),
                  (o || a) && ((n = t.clientX + e.x), (r = t.clientY + e.y)),
                  (u.pageOffset = e),
                  (u.points = [n, r]),
                  (u.cursor = o || a),
                  u
              ...
              !(t === c.start && void 0 !== e.buttons && e.buttons > 1) &&
                (!r.hover || !e.buttons) &&
                ((e.calcPoint = e.points[f.ort]), void n(e, r))))
          );
        },
        o = [];
      return (
          ...
          (function (t, e) {
            ...
            for (f.limit && (t += 1), n = 0; n < t; n += 1)
              null !== (i = e[(r = n % 2)]) &&
                ...
                (!1 === (i = f.format.from(i)) ||
                  isNaN(i) ||
                  !1 === q(p[r], b.toStepping(i), n === 3 - f.dir)) &&
                  P("update", r));
          })(e, o),
          r = 0;
        r < p.length;
    ...
    return (
        ...
        (function () {
          ...
          f.dir && (t.reverse(), f.tooltips.reverse()),
            D("update", function (e, n, r) {
              t[n] &&
                (t[n].innerHTML =
                  !0 === f.tooltips[n] ? e[n] : f.tooltips[n].to(r[n]));
            });
        })(),
      (h = {
        destroy: function () {
          ...
          return O(
            v.map(function (t, e) {
              var n,
                ...
                o =
                  ((n = String(i[2])),
                  (r = n.split(".")).length > 1 ? r[1].length : 0),
                a = w[e],
                s = 100 === t ? null : i[2],
      ...
      (function (t) {
        ...
        if ((t.tap && L(c.start, d, V, { handles: p }), t.hover))
          for (L(c.move, d, T, { hover: !0 }), e = 0; e < p.length; e += 1)
            ["mousemove MSPointerMove pointermove"].forEach(function (t) {
